...
def BS_Dict(statement,ticker_data,val):
    ...
    select_category = ('Capital Stock','Common Stock','Retained Earnings','Treasury Shares Number','Stockholders Equity','Return on Shareholders Equity','Adjusted Return on Equity')
...
def treasury_balance_sheet(ticker_data):
