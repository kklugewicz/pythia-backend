...
def BS_Dict(statement,ticker_data,val):
    ...
    select_category = ('Cash Cash Equivalents And Short Term Investments','Inventory', 'Receivables','Current Assets','Current Ratio','Net PPE','Total Non Current Assets','Total Assets','Return on Asset Ratio')
...
def assets_balance_sheet(ticker_data):
